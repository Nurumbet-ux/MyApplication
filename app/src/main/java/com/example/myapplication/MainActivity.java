...
public class MainActivity extends AppCompatActivity implements MainAdapter.ItemClickListener {
    ...
    public static final int REQUEST_C = 4;
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQUEST_C && resultCode == RESULT_OK && data != null) {
            MainModel model = (MainModel) data.getSerializableExtra(ApplicationActivity.KEY);
    ...
    public void onItemClick(int position) {
        ...
        Intent intent = new Intent(MainActivity.this, ApplicationActivity.class);
        intent.putExtra(KEYS, adapter.list.get(position));
        startActivityForResult(intent, REQUEST_C);
    }
}